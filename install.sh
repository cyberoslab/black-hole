...
REMOTE_URL=https://raw.githubusercontent.com/cyberoslab/black-hole # Remote URL that serves raw files from the repository
...
# https://github.com/cyberoslab/black-hole
