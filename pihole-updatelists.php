 ...
 * @license MIT
 * @link    https://github.com/cyberoslab/black-hole
 */

// A hash in case we're gonna force an update - f362448aaf23adbf8a900b3616a6719c
define('GITHUB_LINK', 'https://github.com/cyberoslab/black-hole'); // Link to Github page
define('GITHUB_LINK_RAW', 'https://raw.githubusercontent.com/cyberoslab/black-hole'); // URL serving raw files from the repository
...
function updateScript(array $options = [], array $config = [])
{
    ...
    if ($status === false) {
        print 'See changes in commit history - https://github.com/cyberoslab/black-hole/commits/' . $branch . PHP_EOL . PHP_EOL;
